...
CREATE INDEX IF NOT EXISTS idx_fact_revenue_customer_id ON fact_revenue(customer_id);
CREATE INDEX IF NOT EXISTS idx_fact_revenue_service_id ON fact_revenue(service_id);
CREATE INDEX IF NOT EXISTS idx_fact_revenue_date_id ON fact_revenue(date_id);
